	...
	else
	{
		...
		else
		{
			...
			while (node)
			{
				...
				Node *newNode = new Node(id,displaylist);
				...
				if(primitives != NULL) {
                    ...
                    while(plane){
                        ...
                        printf("PLANE INT : %d",plane->QueryIntAttribute("parts",&parts));
                        //else
                        //    parts= 10;
                        printf("Plane parts: %d ",parts);
                    ...
                    while(patch){
                        ...
                        Patch *newPatch = new Patch(order, partsU, partsV, compute,controlpointx,controlpointy,controlpointz);
